...
import { getAreaPercentage } from '../lib/calc_helper.js';

const LandCover = ({forest, sparseVegetation, grassland, wetland, water, permSnowIce, bare, agriculture, settlements, total}) => {
  return (
    <div>
      <div className='mt-4'>
        <h4>Land Cover</h4>
